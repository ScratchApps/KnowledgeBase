...
1. Führen Sie die App mit dem Befehl `C:\"Program Files (x86)"\Adguard\Adguard.exe /trace` aus, wenn Sie ein 64-Bit-Windows verwenden, und `C:\"Program Files"\Adguard\Adguard.exe /trace`, wenn Sie ein 32-Bit-Windows verwenden.
